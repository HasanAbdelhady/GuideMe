...
class FlashcardTool(BaseTool):
    ...
    async def _extract_concepts(self, user_message: str, conversation_context: str) -> Dict[str, str]:
        ...
        try:
            ...
            Only include concepts that have clear definitions in the conversation. If no concepts are found, return {{}}.
            """
            ...
            try:
                ...
                logger.warning(f"Failed to parse concepts JSON: {response}")
                return {}
