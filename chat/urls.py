...
urlpatterns = [
    ...
    path('<uuid:chat_id>/update-title/',
         update_chat_title, name='update_chat_title'),
    ...
    path('<uuid:chat_id>/rag-files/', ChatRAGFilesView.as_view(), name='list_rag_files'),
    path('<uuid:chat_id>/rag-files/<int:file_id>/delete/', ChatRAGFilesView.as_view(), name='delete_rag_file'),
    path('<uuid:chat_id>/message/<int:message_id>/edit/', edit_message, name='edit_message'),
