...
class UserRegistrationView(View):
    ...
    def get(self, request):
        ...
        return render(
            request, "users/register.html", {"form": form, "interests": SUBJECT_CHOICES}
        )
    ...
    def post(self, request):
        ...
        return render(
            request, "users/register.html", {"form": form, "interests": interests}
        )
...
class GoogleSignupPreferencesView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        user = request.user
        has_preferences = (
            user.learning_style_visual
            or user.learning_style_auditory
            or user.learning_style_kinesthetic
            or user.learning_style_reading
            or user.interests.exists()
        )
